...
def main():
	...
	parser.add_argument("-o", "--output-dir", default=".", help="directory where functions should be created")
	parser.add_argument("FILE", nargs="*", help="Mine-imator project file")
	parser.add_argument("-t", "--template", action='store_true', help="create a template function to spawn the NPC")
